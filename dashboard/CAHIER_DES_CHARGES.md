...
| `weather.yaml` | Source des données météo et paramètres d'affichage (ajouté le 07.09.2026). | `provider (open-meteo), latitude, longitude, days_home (5), days_detail (15), units` |
